...
| T11_P | Créer l'interface Front-end de modification/suppression d'une US du backlog d'un projet| Amine | 2 | 1 | :x:
| T12_P | Créer l'interface Front-end de saisie et modification de la priorité d'une US du projet| Amine | 2 | 1 | :x:
...
| T22_TEST | Redaction des tests : E2E(Protractor)| Amine | 2 | 1 | :x:
